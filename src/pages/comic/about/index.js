  ...
  return (
    <Layout>
      ...
      <AboutText>
        ...
        <p>
          {` Будем общаться посредством соцсетей (ссылки на них внизу сайта), и абсолютно любой человек сможет предложить абсолютно
          ...
          один простой вопрос: "что будет дальше?"`}
        </p>
